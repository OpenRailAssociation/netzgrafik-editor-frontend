...
## [2.12.0](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/compare/netzgrafik-editor-frontend-v2.11.1...netzgrafik-editor-frontend-v2.12.0) (2026-09-16)
...
* adds port separation metric ([7e43c64](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/7e43c64d291d3d36971126ab26784717c3c20d56))
...
* adds weights in ports optimizer ([675a8f6](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/675a8f6e81194fddc14f60bd73fed3a6042c05d2))
...
* reworks port-ordering candidates generation ([b864e30](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/b864e301a350badbef92c6e1e1a17f822bb7a5ee))
...
* **service:** emit operations after scale netzgrafik ([386f7df](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/386f7dfd5e42b46765aa6831b4477b5741e2d80a))
...
* Show language selector in standalone mode ([fd0a4ec](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/fd0a4ec29642cf0f91665bf49e8a1c5054ebc163))
* transitions path info in view objects ([281649d](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/281649d985dfed1f4d0231ab25322e16d1c934b9))
* upgrades port ordering modes ([4049275](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/404927507c884c246ddaab6ba0f145818e7f3525))
...
* adjust export paths after TypeScript v6 upgrade ([a185819](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/a185819a2306e9a7f002b8f8e1a11d5c45859979))
* avoid ID collision in createNewTrainrunSectionFromDto() ([4cb4538](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/4cb4538a15ef5b9694bbed7328db272bb3e23bce))
...
* emit nodeOperation after auto layout algorithm ([c6247d3](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/c6247d340b89ee435ae1988acd25751609d8d1b9))
...
* fix .md typos ([03378f0](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/03378f07e8ae979494818a865b9a71e50cf87649))
* fix comments typos ([98c4abb](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/98c4abb99d7c611a36b1a8b8f3351be810b48018))
* fix demo standalone json typo ([e3d5b99](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/e3d5b997ba337413619844f1e9254b912645c6c7))
* fix elements name and translation typos ([35a6632](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/35a6632b46610bc2c9494452b9eadb99d3794b5a))
* fix links ([4e7c474](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/4e7c47412cbac3008e4e685991b9f21d7893a468))
* Improve junction detection w.r.t. performance ([#1246](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/issues/1246)) ([1af64a3](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/1af64a3efb99a4eaff27931e064cf0408b8ca1dc))
...
* **model:** make Node.connectionTime nullable ([3714e09](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/3714e092ab01c1191c8dcd5ef5ede02fbce7b247))
...
* perlenkette node name ellipsis when connection time is undefined ([d2f10e3](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/d2f10e3003cdcd23c2e957ff714a81ed3008e2f5))
* **perlenkette:** render and scroll correctly in Safari ([#1292](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/issues/1292)) ([6881274](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/6881274577002bfa4f14d4f81dcd7c1834352f7e)), closes [#1026](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/issues/1026)
* remove unused @HostListener arguments ([fb60675](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/fb60675888cf23e7cd8ebe75285ea22a237ec1cd))
* replace toogle by toggle ([e1bd2d6](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/e1bd2d68db6c9f6cb9593f07860e7ca8cc0e6fb3))
...
* **services:** bail out from propagateConsecutiveTimesForTrainrun() on infinite loop ([759d48a](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/759d48a1b1b76d40eb4daf101ee5e007f3757e6d))
* **services:** fix O/D matrix tooltip ([0657e34](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/0657e34b71fe45fcee6b906848152efc1d0c74f5))
...
* version mismatch ([#1253](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/issues/1253)) ([bcfb2b7](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/bcfb2b76365a1d3943d3f4ef9fdc83bae68ddcb4))
* **view:** accept objects in TimeStepperComponent.inputClass ([9c5a099](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/9c5a099abed199a19076fce1cd727e7334133321))
...
* **view:** fix selection.on() ([adf99eb](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/adf99eb1942039f676f0b46e3f4b1ee68e7a3861))
...
* **view:** Perlenkette times positions regardless of Left/Right hand traffic ([c5d3a72](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/c5d3a72f878b061725255c29413451c37969d8cc))
* **view:** require mousedown event inside view to start panning ([a268283](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/a26828385e6e238f2cbb03fa6ce802426a4959eb))
* **view:** travel time position when target is left and section is symmetric ([d196d95](https://github.com/OpenRailAssociation/netzgrafik-editor-frontend/commit/d196d9533e27daab579032358e9f88a255d46e9b))
