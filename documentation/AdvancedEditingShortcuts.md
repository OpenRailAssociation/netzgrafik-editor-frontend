...
|                                                       `l`                                                        |                                                                    Optimizes the layout of the netzgrafik. If nodes or trainrun sections are selected, only the selected elements are optimized. If nothing is selected, the entire netzgrafik is optimized.                                                                    |
