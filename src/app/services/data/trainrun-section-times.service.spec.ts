...
describe("TrainrunSectionTimesService", () => {
  ...
  let trairunSectionTimesService: TrainrunSectionTimesService;
  ...
  beforeEach(() => {
    ...
    trairunSectionTimesService = new TrainrunSectionTimesService(
      trainrunService,
      trainrunSectionService,
      filterService,
  ...
  describe("update", () => {
    ...
    const onChanged = {
      ...
      travelTime: () => trairunSectionTimesService.onTravelTimeChanged(),
    };
