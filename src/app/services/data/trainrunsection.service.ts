...
import {TrainrunSectionNodePair, DirectedTrainrunSectionProxy} from "../util/trainrun.iterator";
...
export class TrainrunSectionService implements OnDestroy {
  ...
  setTimeStructureToTrainrunSections(
    ...
    const oldTotalTravelTime = this.trainrunService.getCumulativeTravelTime(trainrunSection, 'sourceToTarget');
