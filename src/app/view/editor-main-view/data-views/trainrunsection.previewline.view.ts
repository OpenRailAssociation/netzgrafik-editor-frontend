...
export class DragCollapsedNodeInfo {
  constructor(
...
export class TrainrunSectionPreviewLineView {
  ...
  private dragCollapsedNodeInfo: DragCollapsedNodeInfo = null;
  ...
  startDragCollapsedNode(dragCollapsedNodeInfo: DragCollapsedNodeInfo, startPosition: Vec2D) {
    if (!this.versionControlService?.getVariantIsWritable()) {
      return;
    }
  ...
  getDragCollapsedNodeInfo(): DragCollapsedNodeInfo {
