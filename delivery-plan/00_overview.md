...
1. [Datenvertrag und Persistenz](01_epic_infrastructure_resources/01_feature_resource_foundation/01_story_data_contract_and_persistence.md): Definiert Ressourcen mit einer fuehrenden Gleiskapazitaet.
2. [Knoten-Infrastruktur](01_epic_infrastructure_resources/01_feature_resource_foundation/02_story_node_infrastructure_panel.md): Liefert und visualisiert die konfliktfreie Gleisbelegung pro Knoten.
3. [Strecken-Infrastruktur](01_epic_infrastructure_resources/01_feature_resource_foundation/03_story_section_infrastructure_panel.md): Zeigt die gemeinsame Kapazitaet und berechnete Gleissegmente jeder physischen Kante A-B.
